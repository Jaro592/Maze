...
namespace View
{
  public class MenuView
  {
    public static void DisplayMenu(ConsoleKey key = ConsoleKey.None)
    {
      ...
      string bfs = "🟦Press 3 BFS 📬                  🟦";
      string Astar = "🟦Press 4 A⭐️                     🟦  ";
      string dijkstra = "🟦Press 5 Dijkstra 🔎             🟦  ";
      string manual = "🟦Press P to Play manually        🟦  ";
      string quit = "🟦Press Q to Quit                 🟦  ";
      string end = "  🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦    ";

      string[] lines = { start + "\n" + choice, recursive, stack, bfs, Astar, dijkstra, manual, quit, end };
